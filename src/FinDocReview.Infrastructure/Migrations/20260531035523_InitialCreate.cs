...
namespace FinDocReview.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceChunkIdsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiQueryLogs_Documents_DocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeyRisksJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiQueryLogs_CreatedAt",
                table: "AiQueryLogs",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AiQueryLogs_DocumentId",
                table: "AiQueryLogs",
                column: "DocumentId");
